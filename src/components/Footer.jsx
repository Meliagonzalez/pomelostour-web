        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex gap-6">
            ...
            <a
              ...
              className={`inline-flex items-center gap-2 rounded text-slate-300 hover:text-brand transition-colors duration-150 ${focusRing}`}
            >
          ...
          <div className="w-full max-w-xl border-t border-slate-800 pt-4">
